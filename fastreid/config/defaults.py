...
# Hyper-parameters for SAM-ReID
_C.MODEL.BACKBONE.LAYER_FILTER = [0]
_C.MODEL.BACKBONE.WEIGHT_LAMBDA = 1.0
# 
...
_C.MODEL.BACKBONE.POINT_PROMPT = True
_C.MODEL.BACKBONE.BOX_PROMPT = True
...
_C.MODEL.LOSSES.HINT=CN()
_C.MODEL.LOSSES.HINT.LAMBDA=1.0
_C.MODEL.LOSSES.HINT.NUM_BLOCKS=9
