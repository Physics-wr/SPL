...
def _train_loader_from_config(cfg, *, train_set=None, transforms=None, sampler=None, **kwargs):
    ...
    if train_set is None:
        ...
        for d in cfg.DATASETS.NAMES:
            ...
            train_pids.append(data.get_num_pids(data.train))
    ...
    cfg.DATASETS.NUM_PIDS = tuple(train_pids)
    logger = logging.getLogger(__name__)
    logger.info(f"Auto-scaling the num_pids={cfg.DATASETS.NUM_PIDS}")
    ...
    if sampler is None:
        ...
        elif sampler_name == "DomainIdentitySampler":
            sampler = samplers.DomainIdentitySampler(train_set.img_items, mini_batch_size, num_instance)
        elif sampler_name == "SHS":
            sampler = samplers.SHS(train_set.img_items, mini_batch_size, num_instance,transforms)
        else:
